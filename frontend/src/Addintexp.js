  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Interview Experience</h5>
      ...
      <div class="modal-footer">
        <button type="button"  style={{  color : "white" , backgroundColor:"#A06EC4"}} class="btn " onClick={editsave} data-dismiss="modal"  >Save</button>

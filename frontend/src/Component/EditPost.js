...
class EditPost extends Component {
  ...
  onSubmit = (e) => {
    ...
    if (this.validate(Name, description)) {
      ...
      console.log(data);
      axios.put(`http://localhost:2000/posts/update/${id}`, data).then((res) => {
        if (res.data.success) {
          alert("Updated");
    ...
    return (
      <div>
        ...
        <div className="col-md-10 mt-3 mmx-auto">
          <h1 className="h3 mb-3 font-weight-normal" style={{marginLeft:"100px",marginTop:"30px",backgroundColor:'#EBE0F5', border:'2px solid #4C2965', borderRadius:'12px',paddingBottom:'9px'}}>Update the Post</h1>
